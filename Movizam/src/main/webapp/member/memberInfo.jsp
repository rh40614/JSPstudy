...
<meta charset="UTF-8">
<title>정보 관리</title>
<link rel="stylesheet" href="<%=request.getContextPath() %>/member/memberInfo.css">
...
<a href="<%=request.getContextPath()%>/member/memberEdit.do"><button type="button" id="editbtn" onclick="editFn()">수정하기</button></a>
</div>
