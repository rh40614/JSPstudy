...
<ul class="tab_title">
	...
	<li class="on"><a href="<%=request.getContextPath()%>/board/likeList.do">추천게시판</a></li>
...
if(pm.isPrev() == true){	
	out.print("<a href='"+request.getContextPath()+"/board/likeList.do?page="+(pm.getStartPage()-1)+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType() +"'>◀</a>");
}
%>
</td>
<td>
...
for(int i=pm.getStartPage(); i<= pm.getEndPage();i++){
	out.print("<a href='"+request.getContextPath()+"/board/likeList.do?page="+i+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType()+"'>"+i+"</a>");
}
...
if(pm.isNext() && pm.getEndPage() >0 ){ 
	...
	out.print("<a href='"+request.getContextPath()+"/board/likeList.do?page="+(pm.getEndPage()+1)+"&keyword="+pm.encoding(pm.getScri().getKeyword())+"&searchType="+pm.getScri().getSearchType()+"'>▶</a>");
}%>
</td>
</tr>
...
<!-- 검색창 -->
<form name="frm" action="<%=request.getContextPath() %>/board/likeList.do"  method="post"> 
<table id="searchK"> 
<tr>
<td>
<select>
